...
function getItems(items, jsonCategories) {
    ...
    for (const item of items) {
        const result = {
            ...
            textualAmount: item.textualAmount ? item.textualAmount : null,
            pricePerUnit: item.pricePerUnit.full ? item.pricePerUnit.full : null,
            composition: item.composition ? item.composition : null,
